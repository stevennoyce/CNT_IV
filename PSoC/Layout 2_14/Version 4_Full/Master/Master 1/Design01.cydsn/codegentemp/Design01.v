...
module ADC_DelSig_v3_30_1 (
	...
	cy_clock_v1_0
		#(.id("8bda02ab-ec76-474b-8a67-a1480733cde5/b7604721-db56-4477-98c2-8fae77869066"),
	...
	cy_clock_v1_0
		#(.id("8bda02ab-ec76-474b-8a67-a1480733cde5/edd15f43-b66b-457b-be3a-5342345270c8"),
		  .source_clock_id("61737EF6-3B74-48f9-8B91-F7473A442AE7"),
		  .divisor(0),
		  .period("3906250000"),
		  .is_direct(0),
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=0, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=0, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC_Vgs, CY_INSTANCE_SHORT_NAME=VDAC_Vgs, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=VDAC_Vgs, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=125, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=2000, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC_Vds, CY_INSTANCE_SHORT_NAME=VDAC_Vds, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=VDAC_Vds, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=125, Strobe_Mode=0, VDAC_Range=4, VDAC_Speed=0, Voltage=2000, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC_Ref, CY_INSTANCE_SHORT_NAME=VDAC_Ref, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.1 Update 1, INSTANCE_NAME=VDAC_Ref, )
...
module top ;
	...
	wire [0:0] tmpOE__Pin_SolutionGate_net;
	wire [0:0] tmpFB_0__Pin_SolutionGate_net;
	wire [0:0] tmpIO_0__Pin_SolutionGate_net;
	wire [0:0] tmpINTERRUPT_0__Pin_SolutionGate_net;
	electrical [0:0] tmpSIOVREF__Pin_SolutionGate_net;
	...
	assign tmpOE__Pin_SolutionGate_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    VDAC8_v1_90_4 VDAC_Vds (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_189));
    defparam VDAC_Vds.Data_Source = 0;
    defparam VDAC_Vds.Initial_Value = 125;
    defparam VDAC_Vds.Strobe_Mode = 0;

	wire [0:0] tmpOE__Pin_Vds_net;
	wire [0:0] tmpFB_0__Pin_Vds_net;
	wire [0:0] tmpIO_0__Pin_Vds_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Vds_net;
	electrical [0:0] tmpSIOVREF__Pin_Vds_net;

	cy_psoc3_pins_v1_10
		#(.id("5d768a13-20b3-45d1-9ce6-fe7b2c158df4"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_Vds
		 (.oe(tmpOE__Pin_Vds_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_Vds_net[0:0]}),
		  .analog({Net_194}),
		  .io({tmpIO_0__Pin_Vds_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_Vds_net),
		  .interrupt({tmpINTERRUPT_0__Pin_Vds_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_Vds_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_Vss_net;
	wire [0:0] tmpFB_0__Pin_Vss_net;
	wire [0:0] tmpIO_0__Pin_Vss_net;
	wire [0:0] tmpINTERRUPT_0__Pin_Vss_net;
	electrical [0:0] tmpSIOVREF__Pin_Vss_net;

	cy_psoc3_pins_v1_10
		#(.id("d897ddac-8ddf-4a56-9992-12b9a6662dce"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__Pin_Vss_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    VDAC8_v1_90_5 VDAC_Ref (
        .strobe(1'b0),
        .data(8'b00000000),
        .vOut(Net_26));
    defparam VDAC_Ref.Data_Source = 0;
    defparam VDAC_Ref.Initial_Value = 125;
    defparam VDAC_Ref.Strobe_Mode = 0;
    ...
    Timer_v2_80_8 CommunicationTimer (
        .reset(Net_12),
        .interrupt(Net_89),
        .enable(1'b1),
        .trigger(1'b1),
        ...
        .tc(Net_148),
        .clock(Net_10));
    defparam CommunicationTimer.CaptureCount = 2;
    defparam CommunicationTimer.CaptureCounterEnabled = 0;
    defparam CommunicationTimer.DeviceFamily = "PSoC5";
    defparam CommunicationTimer.InterruptOnCapture = 0;
    defparam CommunicationTimer.InterruptOnTC = 1;
    defparam CommunicationTimer.Resolution = 8;
    defparam CommunicationTimer.SiliconRevision = "0";
	...
	wire [0:0] tmpOE__Pin_I12_net;
	wire [0:0] tmpFB_0__Pin_I12_net;
	wire [0:0] tmpIO_0__Pin_I12_net;
	wire [0:0] tmpINTERRUPT_0__Pin_I12_net;
	electrical [0:0] tmpSIOVREF__Pin_I12_net;

	cy_psoc3_pins_v1_10
		#(.id("f4791615-9198-4084-b796-dd6df9c77f0a"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__Pin_I12_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_I11_net;
	wire [0:0] tmpFB_0__Pin_I11_net;
	wire [0:0] tmpIO_0__Pin_I11_net;
	wire [0:0] tmpINTERRUPT_0__Pin_I11_net;
	electrical [0:0] tmpSIOVREF__Pin_I11_net;

	cy_psoc3_pins_v1_10
		#(.id("f94f2f4d-cc9a-47de-975d-400d1ea3dac1"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pin_I1_GND_net;
	wire [0:0] tmpFB_0__Pin_I1_GND_net;
	wire [0:0] tmpIO_0__Pin_I1_GND_net;
	wire [0:0] tmpINTERRUPT_0__Pin_I1_GND_net;
	electrical [0:0] tmpSIOVREF__Pin_I1_GND_net;

	cy_psoc3_pins_v1_10
		#(.id("4230e3cf-9487-4acb-8b86-f0eaae9e263c"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__Pin_I1_GND_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_BackGate_net;
	wire [0:0] tmpFB_0__Pin_BackGate_net;
	wire [0:0] tmpIO_0__Pin_BackGate_net;
	wire [0:0] tmpINTERRUPT_0__Pin_BackGate_net;
	electrical [0:0] tmpSIOVREF__Pin_BackGate_net;

	cy_psoc3_pins_v1_10
		#(.id("b879bdd2-bdd6-46d1-906e-3af619ec8ed3"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__Pin_BackGate_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_LocalGates_net;
	wire [0:0] tmpFB_0__Pin_LocalGates_net;
	wire [0:0] tmpIO_0__Pin_LocalGates_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LocalGates_net;
	electrical [0:0] tmpSIOVREF__Pin_LocalGates_net;

	cy_psoc3_pins_v1_10
		#(.id("3ea3e639-aefd-4e40-b15b-74ff6ed4b969"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__Pin_LocalGates_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
