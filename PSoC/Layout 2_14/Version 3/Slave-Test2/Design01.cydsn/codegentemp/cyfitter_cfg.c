...
void AMux_1_Set(uint8 channel)
{
	switch (channel) {
		...
		case 15u:
			...
			break;
		case 16u:
			CY_SET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL5, (CY_GET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL5) | 0x6000u));
			break;
		case 17u:
			CY_SET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL5, (CY_GET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL5) | 0x60u));
			break;
		case 18u:
		...
		case 21u:
			...
			break;
		case 22u:
			CY_SET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL4, (CY_GET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL4) | 0x06u));
			break;
		case 23u:
			CY_SET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL4, (CY_GET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL4) | 0x60u));
			break;
		case 24u:
			CY_SET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL4, (CY_GET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL4) | 0x600u));
			break;
		case 25u:
			CY_SET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL4, (CY_GET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL4) | 0x6000u));
			break;
		case 26u:
...
void AMux_1_Unset(uint8 channel)
{
	switch (channel) {
		...
		case 15u:
			...
			break;
		case 16u:
			CY_SET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL5, (CY_GET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL5) & 0xffff9fffu));
			break;
		case 17u:
			CY_SET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL5, (CY_GET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL5) & 0xffffff9fu));
			break;
		case 18u:
		...
		case 21u:
			...
			break;
		case 22u:
			CY_SET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL4, (CY_GET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL4) & 0xfffffff9u));
			break;
		case 23u:
			CY_SET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL4, (CY_GET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL4) & 0xffffff9fu));
			break;
		case 24u:
			CY_SET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL4, (CY_GET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL4) & 0xfffff9ffu));
			break;
		case 25u:
			CY_SET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL4, (CY_GET_REG32((void CYXDATA *)CYREG_HSIOM_PORT_SEL4) & 0xffff9fffu));
			break;
		case 26u:
...
void cyfitter_cfg(void)
{
...

	{
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0xFFAA0000u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC2), 0x000000F0u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT5_BASE), 0x0000000Au);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT5_PC2), 0x0000000Au);
