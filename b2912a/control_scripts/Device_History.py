...
if __name__ == '__main__':
	...
	#makePlots('C127', 'X', '15-16', 155, 155, 'FullStaticBiasHistory', (2.2 *3.5/2.2,1.408 *3.5/2.2), dataFolder='../data', saveFolder='../CurrentPlots', plotSaveName='Figure S? no grounding or floating - ', saveFigures=True, showFigures=False, plotInRealTime=True, plot_mode_parameters={'publication_mode':False,'staticBiasSegmentDividers':True,'plotGradient':True})
	#makePlots('C127', 'X', '15-16', 3, 6, 'FullSubthresholdCurveHistory', (1.45 *2.24/1.55,1.55 *2.24/1.55), dataFolder='../data', saveFolder='../CurrentPlots', plotSaveName='Figure S3a - ', saveFigures=True, showFigures=False, plot_mode_parameters={'publication_mode':False,'errorBarsOn':False,'enableColorBar':False,'legendLabels':['Before','After']})
	#makePlots('C127', 'X', '15-16', 3, 6, 'FullTransferCurveHistory', (1.48 *2.24/1.74,1.74 *2.24/1.74), dataFolder='../data', saveFolder='../CurrentPlots', plotSaveName='Figure S3b - ', saveFigures=True, showFigures=False, plot_mode_parameters={'publication_mode':False,'errorBarsOn':False,'enableColorBar':False,'legendLabels':['Before','After']})
